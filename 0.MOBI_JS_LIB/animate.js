...
//iScroll Configuration
  ...
  function loaded () {
    ...
    myScroll = new IScroll('#wrapper', {scrollX: true, scrollY: false, tap: true, startX: start_point });
    my2ndScroll = new IScroll('#card_content', {bounce:false, tap: true});
...
$(".start_btn").click(function(){
    $(".content_pic_img").animate({width:'21%',height:'21%',left:'39%',top:'55%'},1);
    $(".start").fadeOut();
    $(".content_pic").fadeIn(1);
    $(".door_l").animate({left:'13.9%'});
    $(".door_r").animate({left:'59.8%'});
    $(".content_pic_img").delay(700).animate({width:'100%',height:'100%',left:'0%',top:'0%'},1000);
    $(".content_pic_img").fadeOut(3000);
    $(".layer_2").delay(2000).fadeIn(1,function(){
        myScroll.refresh();
        myScroll.scrollTo(scrolling_mid,0);
        setTimeout(function(){myScroll.scrollTo(scrolling_left,0,1400,IScroll.utils.ease.quadratic);},1);
        setTimeout(function(){myScroll.scrollTo(scrolling_right,0,1400,IScroll.utils.ease.quadratic);},1200);
        setTimeout(function(){myScroll.scrollTo(scrolling_mid,0,1200,IScroll.utils.ease.quadratic);},2700);
    });
    $(".bg_img").delay(800).animate({width:'800%',height:'800%',left:'-400%',top:'-470%'},1000);
    $(".door_l").delay(400).animate({width:'400%',height:'400%',left:'-600%',top:'-180%'},2000);
    $(".door_l_img").delay(800).animate({width:'100%',height:'100%'});
    $(".door_r").delay(400).animate({width:'400%',height:'400%',left:'300%',top:'-180%'},2000);
    $(".door_r_img").delay(800).animate({width:'100%',height:'100%'});
    $(".people_img").delay(800).animate({width:'800%',height:'800%',left:'-800%',top:'800%'});
    $(".car_img").delay(800).animate({width:'800%',height:'800%',top:'800%'});
    $(".layer_1").delay(2000).fadeOut(1);
    //$("#wrapper").delay(1500).animate({left:'0%'},1);
})
...
$(".card_close").click(function(){
    $(".layer_3").fadeOut('slow',function(){
        setTimeout(function(){my2ndScroll.scrollTo(0,0);},1);
    });
    $(".close_door").removeClass("open");
});
//door_1
...
$(".indoor_door_2").on("tap",function(){
    ...
    $("#card_scroller").css("height","15.12rem",function(){my2ndScroll.scrollTo(0,0)});
    $(".layer_3").delay(600).fadeIn('slow',function(){
        setTimeout(function(){
            my2ndScroll.refresh();
        },100);
